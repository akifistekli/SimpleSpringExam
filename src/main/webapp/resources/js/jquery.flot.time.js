...
(function($) {
	...
	var options = {
		xaxis : {
			timezone : null, // "browser" for local to the client or timezone
								// for timezone-js
									...
									function(axisName, axis) {
										...
										if (opts.mode == "time") {
											axis.tickGenerator = function(axis) {
												...
												// make quarter use a
												// possibility if quarters are
												// mentioned in either of these
												// options
												...
												// special-case the possibility
												// of several years

												if (unit == "year") {

													// if given a minTickSize in
													// years, just use it,
													// ensuring that it's an
													// integer
											...
											axis.tickFormatter = function(v,
												...
												// possibly use quarters if
												// quarters are mentioned in
												// any of these places
