				...
				for (i = 0; i < markings.length; ++i) {
					...
					if (xequal || yequal) {
						var lineWidth = m.lineWidth
								|| options.grid.markingsLineWidth, subPixel = lineWidth % 2 ? 0.5
								: 0;
						ctx.beginPath();
			...
			$
					.each(
							...
							function(_, axis) {
								...
								// Remove text before checking for axis.show and
								// ticks.length;
								// otherwise plugins, like flot-tickrotor, that
								// draw their own
								// tick labels will end up with both theirs and
								// the defaults.
